...
constexpr Vertex positions[] = {
    {0.0f,  1.0f,  0.0f, 0.0, 0.0}, // 0(0, 2)
    {1.0f,  1.0f,  0.0f, 0.25, 0.0},
    {0.0f,  1.0f,  1.0f, 0.0, 0.25},
    {1.0f,  1.0f,  1.0f, 0.25, 0.25}, // 3

    {0.0f,  0.0f,  0.0f, 0.0, 0.0}, // 4 (0, 1)
    {0.0f,  1.0f,  0.0f, 0.0, 0.25},
    {1.0f,  0.0f,  0.0f, 0.25, 0.0},
    {1.0f,  1.0f,  0.0f, 0.25, 0.25},
    {0.0f,  0.0f,  1.0f, 0.0, 0.0},
    {0.0f,  1.0f,  1.0f, 0.0, 0.25},
    {1.0f,  0.0f,  1.0f, 0.25, 0.0},
    {1.0f,  1.0f,  1.0f, 0.25, 0.25}, // 11

    {0.0f,  0.0f,  0.0f, 0.0, 0.0}, // 12 (1,2)
    {0.0f,  1.0f,  0.0f, 0.0, 0.25},
    {1.0f,  0.0f,  0.0f, 0.0, 0.0},
    {1.0f,  1.0f,  0.0f, 0.0, 0.25},
    {0.0f,  0.0f,  1.0f, 0.25, 0.0},
    {0.0f,  1.0f,  1.0f, 0.25, 0.25},
    {1.0f,  0.0f,  1.0f, 0.25, 0.0},
    {1.0f,  1.0f,  1.0f, 0.25, 0.25}, // 19

    {0.0f,  0.0f,  0.0f, 0.0, 0.0}, // 20 (0,2)
    {1.0f,  0.0f,  0.0f, 0.25, 0.0},
    {0.0f,  0.0f,  1.0f, 0.0, 0.25},
    {1.0f,  0.0f,  1.0f, 0.25, 0.25}
};
