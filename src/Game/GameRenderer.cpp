...
constexpr Vertex positions[NUM_VERTICES] = {
    ...
    {-0.5f,  0.5f,  0.5f, 0.0, 1.0},
    { 0.5f, -0.5f,  0.5f, 1.0, 0.0},
    { 0.5f,  0.5f,  0.5f, 1.0, 1.0}, // 11

    {-0.5f, -0.5f, -0.5f, 0.0, 0.0}, // 12 (1,2)
    {-0.5f,  0.5f, -0.5f, 0.0, 1.0},
    { 0.5f, -0.5f, -0.5f, 0.0, 0.0},
    { 0.5f,  0.5f, -0.5f, 0.0, 1.0},
    {-0.5f, -0.5f,  0.5f, 1.0, 0.0},
    {-0.5f,  0.5f,  0.5f, 1.0, 1.0},
    { 0.5f, -0.5f,  0.5f, 1.0, 0.0},
    { 0.5f,  0.5f,  0.5f, 1.0, 1.0}, // 19

    {-0.5f, -0.5f, -0.5f, 0.0, 0.0}, // 20 (0,2)
    { 0.5f, -0.5f, -0.5f, 1.0, 0.0},
    {-0.5f, -0.5f,  0.5f, 0.0, 1.0},
    { 0.5f, -0.5f,  0.5f, 1.0, 1.0}
};
